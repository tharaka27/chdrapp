...
import static com.echdr.android.echdrapp.service.Constants.AGE_COMPLETED_FIVE_YEARS_THERAPEUTIC;
...
public class TherapeuticOutcomeValidator extends Validator{
    private String TAG = "TherapeuticOutcomeValidator";
    ...
    public boolean validate(){
        ...
        if (spinner_Enrollment.getSelectedItemPosition() == AGE_COMPLETED_FIVE_YEARS_THERAPEUTIC){
