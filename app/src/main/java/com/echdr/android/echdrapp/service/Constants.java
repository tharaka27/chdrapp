...
public class Constants {
    public static String APP_LANGUAGE_SINHALA = "si";
    public static String APP_LANGUAGE_ENGLISH= "en";
    public static String APP_LANGUAGE_TAMIL = "ta";
    public static String ERHMIS_SERVER_URL = "https://www.erhmis.fhb.health.gov.lk/nutrition/api/"; //"https://www.erhmis.fhb.health.gov.lk/erhmis2356/api/";
